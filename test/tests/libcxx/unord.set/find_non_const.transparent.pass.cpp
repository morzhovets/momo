...
void main()
{
...

    {
      ...
      using set_type = unord_set_type<unordered_set, transparent_hash,
                                 std::equal_to<> >;
...

    {
      ...
      using set_type = unord_set_type<unordered_set, transparent_hash_final,
...

    {
      ...
      using set_type = unord_set_type<unordered_set, non_transparent_hash,
                                 std::equal_to<> >;
