...
void main()
{
...

    {
      ...
      using set_type =
          const unord_set_type<unordered_set, transparent_hash_final, transparent_equal_final>;
      test_transparent_count<set_type>(key_type{1},  key_type{2});
    }

    {
      // Make sure conversions do happen for non-transparent hasher
      using set_type = const unord_set_type<unordered_set, non_transparent_hash, std::equal_to<> >;
...

    {
      ...
      using set_type =
          const unord_set_type<unordered_set, transparent_hash, std::equal_to<key_type> >;
      test_non_transparent_count<set_type>(key_type{1},  key_type{2});
    }

    {
      ...
      using set_type =
          const unord_set_type<unordered_set, non_transparent_hash, std::equal_to<key_type> >;
      test_non_transparent_count<set_type>(key_type{1},  key_type{2});
    }
}
