...
void main()
{
#if _LIBCPP_DEBUG >= 1
    {
        ...
        unordered_multimap<int, int> c1(a1, a1+sizeof(a1)/sizeof(a1[0]));
        unordered_multimap<int, int> c2(a2, a2+sizeof(a2)/sizeof(a2[0]));
        unordered_multimap<int, int>::iterator i1 = c1.begin();
        unordered_multimap<int, int>::iterator i2 = c2.begin();
        swap(c1, c2);
        c1.erase(i2);
        c2.erase(i1);
        unordered_multimap<int, int>::iterator j = i1;
        (void)j;
