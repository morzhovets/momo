...
void main()
{
...

    {
      ...
      using map_type = unord_map_type<unordered_map, transparent_hash,
                                 std::equal_to<> >;
...

    {
      ...
      using map_type = unord_map_type<unordered_map, transparent_hash_final,
...

    {
      ...
      using map_type = unord_map_type<unordered_map, non_transparent_hash,
                                 std::equal_to<> >;
