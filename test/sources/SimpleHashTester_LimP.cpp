/**********************************************************\
  ...
  test/sources/SimpleHashTester_LimP.cpp
...
static int testSimpleHash = []
{
	...
	SimpleHashTester::TestTemplHashSet<BUCKET( 2, 99, true),  4, 1>("momo::HashBucketLimP< 2, 99, true>");
	...
	SimpleHashTester::TestTemplHashSet<BUCKET( 3,  2, true),  8, 1>("momo::HashBucketLimP< 3,  2, true>");
	...
	SimpleHashTester::TestTemplHashSet<BUCKET( 5,  5, true), 16, 2>("momo::HashBucketLimP< 5,  5, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET( 6,  8, true),  8, 8>("momo::HashBucketLimP< 6,  8, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET( 7, 11, true), 16, 4>("momo::HashBucketLimP< 7, 11, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET( 8, 33, true), 16, 8>("momo::HashBucketLimP< 8, 33, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET(10, 32, true), 32, 8>("momo::HashBucketLimP<10, 32, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET(12, 55, true), 32, 1>("momo::HashBucketLimP<12, 55, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET(14,  1, true), 32, 8>("momo::HashBucketLimP<14,  1, true>");
	SimpleHashTester::TestTemplHashSet<BUCKET(15, 32, true), 32, 8>("momo::HashBucketLimP<15, 32, true>");
