...
void main()
{
...

    {
      ...
      using map_type = const unord_map_type<unordered_map, transparent_hash_final, transparent_equal_final>;
      test_transparent_contains<map_type>(ilist_type{{1, 2}, {2, 3}});
    }

    {
      // Make sure conversions do happen for non-transparent hasher
      using map_type = const unord_map_type<unordered_map, non_transparent_hash,
                                       std::equal_to<> >;
...

    {
      ...
      using map_type = const unord_map_type<unordered_map, transparent_hash,
