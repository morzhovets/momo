...
void main()
{
...

    {
      ...
      using map_type = const unord_map_type<unordered_multimap, transparent_hash, std::equal_to<> >;
...

    {
      ...
      using map_type =
          const unord_map_type<unordered_multimap, transparent_hash_final, transparent_equal_final>;
      test_transparent_count<map_type>(ilist_type{{1, 2}, {1, 3}, {2, 3}});
    }

    {
      // Make sure conversions do happen for non-transparent hasher
      using map_type = const unord_map_type<unordered_multimap, non_transparent_hash, std::equal_to<> >;
...

    {
      ...
      using map_type =
          const unord_map_type<unordered_multimap, transparent_hash, std::equal_to<key_type> >;
      test_non_transparent_count<map_type>(ilist_type{{1, 2}, {1, 3}, {2, 3}});
    }

    {
      ...
      using map_type =
          const unord_map_type<unordered_multimap, non_transparent_hash, std::equal_to<key_type> >;
      test_non_transparent_count<map_type>(ilist_type{{1, 2}, {1, 3}, {2, 3}});
    }
}
