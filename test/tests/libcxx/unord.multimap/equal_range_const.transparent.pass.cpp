...
void main()
{
...

    {
      ...
      using map_type = const unord_map_type<unordered_multimap, transparent_hash,
                                       std::equal_to<> >;
...

    {
      ...
      using map_type = const unord_map_type<unordered_multimap, transparent_hash_final,
...

    {
      ...
      using map_type = const unord_map_type<unordered_multimap, non_transparent_hash,
                                       std::equal_to<> >;
