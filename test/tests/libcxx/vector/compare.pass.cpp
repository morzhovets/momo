...
TEST_CONSTEXPR_CXX20 bool test() {
    {
        const vector<int> c1, c2;
        assert(testComparisons(c1, c2, true, false));
    }
    {
        const vector<int> c1(1, 1), c2(1, 2);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        const vector<int> c1, c2(1, 2);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        int items1[3] = {1, 2, 1};
        int items2[3] = {1, 2, 2};
        const vector<int> c1(items1, items1 + 3);
        const vector<int> c2(items2, items2 + 3);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        int items1[3] = {3, 2, 3};
    ...
    }
    {
        int items1[2] = {1, 2};
        int items2[3] = {1, 2, 0};
        const vector<int> c1(items1, items1 + 2);
        const vector<int> c2(items2, items2 + 3);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        int items1[3] = {1, 2, 0};
        const vector<int> c1(items1, items1 + 3);
        const vector<int> c2(1, 3);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        const vector<LessAndEqComp> c1, c2;
        assert(testComparisons(c1, c2, true, false));
    }
    {
        const vector<LessAndEqComp> c1(1, LessAndEqComp(1));
        const vector<LessAndEqComp> c2(1, LessAndEqComp(1));
        assert(testComparisons(c1, c2, true, false));
    }
    {
        const vector<LessAndEqComp> c1(1, LessAndEqComp(1));
        const vector<LessAndEqComp> c2(1, LessAndEqComp(2));
        assert(testComparisons(c1, c2, false, true));
    }
    {
        const vector<LessAndEqComp> c1;
        const vector<LessAndEqComp> c2(1, LessAndEqComp(2));
        assert(testComparisons(c1, c2, false, true));
    }
    {
        ...
        const vector<LessAndEqComp> c1(items1, items1 + 3);
        const vector<LessAndEqComp> c2(items2, items2 + 3);
        assert(testComparisons(c1, c2, false, false));
    }
    {
    ...
    }
    {
        ...
        const vector<LessAndEqComp> c1(items1, items1 + 2);
        const vector<LessAndEqComp> c2(items2, items2 + 3);
        assert(testComparisons(c1, c2, false, true));
    }
    {
        ...
        const vector<LessAndEqComp> c1(items1, items1 + 3);
        const vector<LessAndEqComp> c2(1, LessAndEqComp(3));
        assert(testComparisons(c1, c2, false, true));
    }
    {
